...
//enters when all 7 fields have been filled in
	if ($err_count==0){
        ...
        $sql = "SELECT s_id FROM `team 1` WHERE s_id = ?";
...
<!-- Title Div  -->
	...
	<p>Please answer the following quesions honestly. All fields are required.</p> 
	</div>
...
<!-- Q5 Time log  -->
	<div>
	<h3>Time Log</h3>
	<p>How many hours did you spend working on MSCI 342 this week outside of lab/tutorial time? (Ex. studying, project work, assignments, etc.)</p>
	<input type="number" name="time" min="0" max="20" value="<?php echo $time; ?>">
